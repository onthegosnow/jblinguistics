...
// POST /api/portal/admin/placement/assign - Assign a placement test to someone
export async function POST(request: NextRequest) {
  try {
    ...
    const testCode = await createTestCode({
      ...
      label: `Assigned to ${recipientName || recipientEmail}`,
      notes: notes || `Auto-assigned placement test`,
    });
            ...
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
              ...
              <div style="background: #f8fafc; padding: 32px; border: 1px solid #e2e8f0; border-top: none;">
                ...
                <p style="color: #334155; font-size: 16px; margin: 0 0 24px 0;">
                  You have been assigned a <strong>${languageLabel}</strong> placement test. This test will assess your current proficiency level on the CEFR scale (A1-C2).
                </p>
